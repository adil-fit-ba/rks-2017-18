 ...
 * Use the {@link K1Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class K1Fragment extends Fragment {
    ...
    public static K1Fragment newInstance(PosiljkaVM posiljkaVM) {
        K1Fragment fragment = new K1Fragment();
    ...
    private void do_btnDaljeClick() {
        ...
        Util.otvoriFragmentKaoReplace(getActivity(), R.id.fragmentPlace, K2Fragment.newInstance(posiljkaVM));
    }
